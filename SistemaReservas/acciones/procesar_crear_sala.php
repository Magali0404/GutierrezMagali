...
try {
    ...
    $sql = "INSERT INTO sala (numero_sala, descripcion ,capacidad, elementos, fecha_disponible, hora_inicio, hora_fin)
            VALUES (:numero_sala, :descripcion ,:capacidad, :elementos, :fecha_disponible, :hora_inicio, :hora_fin)";
