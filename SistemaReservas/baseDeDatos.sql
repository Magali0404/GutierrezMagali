...
-- Volcando datos para la tabla reserva_salas.reserva: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla reserva_salas.sala: ~4 rows (aproximadamente)
INSERT INTO `sala` (`id_sala`, `numero_sala`, `capacidad`, `elementos`, `fecha_disponible`, `hora_inicio`, `hora_fin`, `descripcion`) VALUES
	(1, '1', 20, 'tele y cafetera', '2025-11-29', '21:00:00', '22:00:00', 'sala C'),
	(8, '3', 20, 'Tele', '2025-11-27', '22:00:00', '23:00:00', 'sala J'),
	(14, '4', 20, 'cafetera', '2025-11-29', '17:00:00', '18:00:00', 'sala Z');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `dni`, `email`, `telefono`, `contraseña`, `id_rol`) VALUES
	...
	(8, 'claudia', 'minuet', '23009130', 'clau@gmail.com', '3446114452', '$2y$10$HAHaiS7KAjkAPxmwHFLLpeAuiykbHFmI50iLslnm07jA/gDnpj6nm', 2);
