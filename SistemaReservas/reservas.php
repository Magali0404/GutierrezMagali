...
try {
    if ($admin) {
        $sql = "
            SELECT r.id_reserva, r.id_usuario, u.nombre, u.apellido, s.numero_sala, s.capacidad, s.elementos, s.fecha_disponible, s.hora_inicio, s.hora_fin
            FROM reserva r
        ...
        $sql = "
            SELECT r.id_reserva, r.id_usuario, s.numero_sala, s.capacidad, s.elementos, s.fecha_disponible, s.hora_inicio, s.hora_fin
            FROM reserva r
            INNER JOIN sala s ON r.id_sala = s.id_sala
