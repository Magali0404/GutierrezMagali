...
try {
    $sql = "
        SELECT s.id_sala, s.numero_sala, s.capacidad, s.elementos, s.fecha_disponible, s.hora_inicio, s.hora_fin, r.estado
        FROM sala s INNER JOIN reserva r ON s.id_sala = r.id_sala
                ...
                <td>
                    ...
                    <?php else: ?>
                        <form action="acciones/procesar_borrado_sala.php" method="POST">
                            <input type="hidden" value="<?= $sala['id_sala'] ?>">
