<aside class="w-64 h-full bg-white text-gray-800 flex flex-col flex-shrink-0 border-r border-gray-200">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-2xl font-bold text-center">Habibi</h2>
    </div>
    ...
    <nav class="flex-grow mt-6">
        ...
        <a href="clientesInactivos.php" class="flex items-center py-3 px-2 text-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg mx-2">
